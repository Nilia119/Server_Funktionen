// XEH_preInit.sqf
/*
// Wir speichern das Array zuerst in einer Variablen – exakt wie die GX-Funktion es tut:
private _meinePatronen = [
"greenmag_ammo_68x51_N_basic_1Rnd",
"greenmag_ammo_68x51_N_basic_60Rnd",
"greenmag_ammo_68x51_N_basic_300Rnd",
"FirstAidKit"
];

// Jetzt übergeben wir die Variable an ACE:
[
_meinePatronen,
"Patronen",
"\Nilia_GreenMag\Ammo\data\Category.paa"
...
[
	...
	"Patronen",  // localize "STR_NILIA_GREENMAG_AMMO",
	"\Nilia_ZZPatches\Nilia_GreenMag\Ammo\data\Category.paa"
] call ace_arsenal_fnc_addRightPanelButton;
