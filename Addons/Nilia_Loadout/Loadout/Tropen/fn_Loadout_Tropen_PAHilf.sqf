...
_unit setVariable ["Nilia_Waffenklasse", "Standard"]; // TODO: Klasse (AA-Hilfsschütze) erstellen und in allen farben korrekt setzten, Entfernungsmesser, ggf. Klasse "Hilfsschützen"!
...
//hint
systemChat "Ausrüstung (Tropen): Panzerabwehrhilfsschütze geladen!";
