...
//hint
systemChat "Ausrüstung (Tropen): Scharfschütze geladen, sprachen konfiguriert und Rechte (Sani) gesetzt!";
...
_unit addItemToVest "hlc_5rnd_300WM_T_AWM";
_unit addItemToBackpack "ACE_Tripod";
_unit addItemToBackpack "ACRE_PRC117F";
for "_i" from 1 to 3 do {_unit addItemToBackpack "hlc_5rnd_300WM_T_AWM";};
