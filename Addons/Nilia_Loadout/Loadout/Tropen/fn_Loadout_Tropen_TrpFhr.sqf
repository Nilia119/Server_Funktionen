...
_unit setVariable ["Nilia_Waffenklasse", "ULG"]; // TODO: Klasse erstellen und in allen farben korrekt setzten!
...
//hint
systemChat "Ausrüstung (Tropen): Truppführer geladen!";
...
for "_i" from 1 to 7 do {_unit addItemToVest "hlc_30rnd_556x45_SOST_G36";};
