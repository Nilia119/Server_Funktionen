...
//hint
systemChat "Ausrüstung (Fleck): Zugführer geladen, sprachen konfiguriert und Rechte (Sani) gesetzt!";
...
_unit addItemToUniform "ACE_MRE_CreamTomatoSoup";
_unit addItemToUniform "ACE_MRE_ChickenTikkaMasala";
