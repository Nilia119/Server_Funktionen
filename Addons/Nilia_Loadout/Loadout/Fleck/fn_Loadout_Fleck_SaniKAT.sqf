...
for "_i" from 1 to 5 do {_unit addItemToBackpack "kat_IV_16";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "kat_chestSeal";};
for "_i" from 1 to 8 do {_unit addItemToBackpack "kat_IO_FAST";};
...
for "_i" from 1 to 2 do {_unit addItemToBackpack "kat_TXA";};
...
for "_i" from 1 to 9 do {_unit addItemToBackpack "kat_lidocaine";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "kat_naloxone";};
