...
_unit setVariable ["Nilia_Waffenklasse", "DMR"];    // TODO: Eigene Klasse erstellen
...
//hint
systemChat "Ausrüstung (Fleck): Beobachter geladen, sprachen konfiguriert und Rechte (Arzt) gesetzt!";
...
_unit addItemToVest "greenmag_item_speedloader";
...
for "_i" from 1 to 2 do {_unit addItemToBackpack "kat_MFAK";};
