...
player forceAddUniform "W_BW2035_Uniform_Fleck";
...
for "_i" from 1 to 24 do {player addItemToUniform "ACE_elasticBandage";};
...
player addItemToUniform "hlc_30Rnd_556x45_SPR_sg550";
