...
//hint
systemChat "Ausrüstung (Fleck): DMR-Schütze geladen!";
...
for "_i" from 1 to 6 do {_unit addItemToVest "hlc_20Rnd_762x51_T_SCARH";};
...
for "_i" from 1 to 3 do {_unit addItemToBackpack "hlc_20Rnd_762x51_T_SCARH";};
