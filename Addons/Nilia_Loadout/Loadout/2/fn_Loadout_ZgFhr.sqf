...
_unit setVariable ["Nilia_Klasse", "ZgFhr"];
...
//hint
systemChat format ["Ausrüstung (%1): Zugführer wird geladen, sprachen konfiguriert und Rechte (Sani) wurden gesetzt!", _farbe];
[_unit] call Nilia_fnc_SetRank;

// "Add weapons";
_unit addWeapon "CUP_arifle_CZ805_A2";
...
for "_i" from 1 to 2 do {_unit addItemToVest "hlc_100rnd_556x45_Mdim_G36";};
