...
_unit setVariable ["Nilia_Klasse", "Muni"];
...
switch (true) do {
    default {
        ...
        _unit addBackpack "EUFOR_Backpacks_Tortilia_Fleck_Ammo";
    ...
    case ("Tropen" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_Tortilia_TropenD_Ammo";
    ...
    case ("Schnee" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_Tortilia_Schnee_Ammo";
    ...
    case ("Multi" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_Tortilia_Multi_Ammo";
        _unit addWeapon "hlc_rifle_416D145_tan_grip";
        _farbe = "Multitarn";
    };
};
...
//hint
systemChat format ["Ausrüstung (%1): Munitionsträger wird geladen!", _farbe];
...
_unit addItemToVest "ACE_MRE_BeefStew";
...
for "_i" from 1 to 6 do {_unit addItemToBackpack "ACE_WaterBottle";};
_unit addItemToBackpack "ACE_MRE_CreamChickenSoup";
...
for "_i" from 1 to 5 do {_unit addItemToBackpack "greenmag_item_speedloader";};
for "_i" from 1 to 11 do {_unit addItemToBackpack "hlc_30rnd_556x45_SOST_L5";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "rhs_mag_m67";};
