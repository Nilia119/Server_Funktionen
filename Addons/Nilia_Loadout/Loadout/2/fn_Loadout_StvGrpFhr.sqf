...
_unit setVariable ["Nilia_Klasse", "StvGrpFhr"];
_unit setVariable ["Nilia_Waffenklasse", "ULG"]; // TODO: Klasse (GrpFhr) erstellen und in allen farben korrekt setzten, Lasermarkierer, Führungsstuff!
...
_unit addBackpack "EUFOR_Backpacks_Tortilia_Fleck";
...
_unit addBackpack "EUFOR_Backpacks_Tortilia_TropenD";
...
_unit addBackpack "EUFOR_Backpacks_Tortilia_Schnee";
...
_unit addBackpack "EUFOR_Backpacks_Tortilia_Multi";
...
//hint
systemChat format ["Ausrüstung (%1): Stv. GrpFhr. wird geladen und sprachen wurden konfiguriert!", _farbe];
...
for "_i" from 1 to 3 do {_unit addItemToVest "hlc_30rnd_556x45_TDIM_G36";};
