...
_unit setVariable ["Nilia_Waffenklasse", "MG"];
...
//hint
systemChat format ["Ausrüstung (%1): MG-Schütze wird geladen!", _farbe];
...
for "_i" from 1 to 2 do {_unit addItemToVest "hlc_200rnd_556x45_M_SAW";};
