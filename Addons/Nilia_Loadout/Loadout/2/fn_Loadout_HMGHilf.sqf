...
_unit setVariable ["Nilia_Klasse", "Hilfsschütze"];
...
//hint
systemChat format ["Ausrüstung (%1): MG-Hilfsschütze wird geladen!", _farbe];
...
_unit addItemToBackpack "hlc_200rnd_556x45_Mdim_SAW";
