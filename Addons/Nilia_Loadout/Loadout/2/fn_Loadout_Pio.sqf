...
_unit setVariable ["Nilia_Klasse", "Pio"];
...
switch (true) do {
    default {
        ...
        _unit addBackpack "EUFOR_Backpacks_UAV_Fleck";
        _farbe = "Flecktarn";
    };
    case ("Tropen" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_UAV_TropenD";
        _farbe = "Tropentarn";
    };
    case ("Schnee" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_UAV_Schnee";
        _farbe = "Schneetarn";
    };
    case ("Multi" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_UAV_Multi";
        _farbe = "Multitarn";
    };
};

//hint
systemChat format ["Ausrüstung (%1): Pionier wird geladen und Rechte wurden gesetzt!", _farbe];
...
for "_i" from 1 to 10 do {_unit addItemToBackpack "advrepair_SpareParts";};
