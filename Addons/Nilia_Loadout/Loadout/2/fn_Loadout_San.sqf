...
_unit setVariable ["Nilia_Klasse", "Sani"];
...
//hint
systemChat format ["Ausrüstung (%1): Sani wird geladen und Rechte (Arzt) wurden gesetzt!", _farbe];
...
_unit addItemToUniform "50Rnd_570x28_SMG_03_tracer_blue";
for "_i" from 1 to 4 do {_unit addItemToVest "ACE_WaterBottle";};
...
for "_i" from 1 to 3 do {_unit addItemToVest "50Rnd_570x28_SMG_03_tracer_blue";};
