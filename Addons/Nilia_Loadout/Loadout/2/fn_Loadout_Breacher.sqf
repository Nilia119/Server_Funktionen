...
_unit setVariable ["Nilia_Klasse", "Breacher"];
_unit setVariable ["Nilia_Waffenklasse", "Kompakt2"];
...
switch (true) do {
    default {
        ...
        _unit addBackpack "EUFOR_Backpacks_Kitbag_Fleck";
        _farbe = "Flecktarn";
    };
    case ("Tropen" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_Kitbag_TropenD";
        _farbe = "Tropentarn";
    };
    case ("Schnee" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_Kitbag_Schnee";
        _farbe = "Schneetarn";
    };
    case ("Multi" in _farbe): {
        ...
        _unit addBackpack "EUFOR_Backpacks_Kitbag_Multi";
        _farbe = "Multitarn";
    };
};

//hint
systemChat format ["Ausrüstung (%1): Breacher wird geladen und Rechte (EH/EOD) wurden gesetzt!", _farbe];
...
for "_i" from 1 to 9 do {_unit addItemToVest "hlc_30Rnd_10mm_B_MP5";};
...
for "_i" from 1 to 2 do {_unit addItemToBackpack "tsp_breach_block_mag";};
