...
_unit setVariable ["Nilia_Klasse", "TrpFhr"];
...
//hint
systemChat format ["Ausrüstung (%1): Truppführer wird geladen!", _farbe];
...
for "_i" from 1 to 2 do {_unit addItemToUniform "hlc_30rnd_556x45_SOST_G36";};
...
for "_i" from 1 to 2 do {_unit addItemToVest "ACE_HuntIR_monitor";};
...
for "_i" from 1 to 5 do {_unit addItemToVest "hlc_30rnd_556x45_SOST_G36";};
