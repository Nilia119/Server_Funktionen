...
switch (true) do {
    ...
    case ("Zitobe" in _name): {[_unit,"EuDef_Insignia_Zitobe"] remoteExec ["bis_fnc_setUnitInsignia", 0, true]; [_unit, ["germany", "or3a_obergefreiter"]] call etr_ranks_functions_fnc_setIcon; systemChat "Hey, Dompi!";};
