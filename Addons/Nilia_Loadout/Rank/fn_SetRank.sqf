...
//Remove Insignia prior to Adding // Unnötig, nur bei Bugs, remoteExec Zeile wieder aktivieren!
//[_unit,""] call BIS_fnc_setUnitInsignia;
//[_unit, ""] remoteExec ["BIS_fnc_setUnitInsignia", 0];
// TODO! ETR_RANKS in eigene Funktion, sodass unabhängig von Emblem der Name der Einheit gilt, um Ränge aktueller zu halten (nur für eigene Embleme relevant)!
switch (true) do {
    //Spieler mit eigenen Emblemen
    case ("Nilia" in _name): {[_unit,"EuDef_Insignia_Nilia"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Nilia!";};
    case ("Juggernaut" in _name): {[_unit,"EuDef_Insignia_Juggernaut"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Juggernaut!";};
    case ("Fox" in _name): {[_unit,"EuDef_Insignia_Fox"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Fox!";};
    case ("CrasyConsti" in _name): {[_unit,"EuDef_Insignia_CrasyConsti"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, CrasyConsti!";};
    case ("Plutokratie" in _name): {[_unit,"EuDef_Insignia_Plutokratie"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Plutokratie!";};
    case ("Toyo" in _name): {[_unit,"EuDef_Insignia_Toyo"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Toyo!";};
    case ("Sam King" in _name): {[_unit,"EuDef_Insignia_SamKing"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Sam!";};
    case ("Benedikt" in _name): {[_unit,"EuDef_Insignia_Benedikt"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Benedikt!";};
    case ("DieScholle" in _name): {[_unit,"EuDef_Insignia_DieScholle"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, DieScholle!";};
    case ("Zitobe" in _name): {[_unit,"EuDef_Insignia_Zitobe"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Zitobe!";};
    case ("Frosch" in _name): {[_unit,"EuDef_Insignia_Frosch"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Frosch!";};
    case ("Grurai" in _name): {[_unit,"EuDef_Insignia_Grurai"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Grurai!";};
    case ("Okami" in _name): {[_unit,"EuDef_Insignia_Okami"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Okami! ;D";};
    case ("Scharfspelz" in _name): {[_unit,"EuDef_Insignia_Scharfzpelz"] remoteExec ["BIS_fnc_setUnitInsignia", 0, true]; [_unit] call Nilia_fnc_SetETR; systemChat "Hey, Scharfspelz!";};
    //Jäger
