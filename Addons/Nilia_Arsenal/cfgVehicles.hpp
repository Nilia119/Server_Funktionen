class CfgVehicles
{
    ...
    class Nilia_SpawnArsenal : Module_F
    {
        // Standard object definitions:
        scope = 2;										// Editor visibility; 2 will show it in the menu, 1 will hide it.
        displayName = "Limitiertes Arsenal Konfigurieren";				// Name displayed in the menu
        //icon = "\TAG_addonName\data\icon_Nuke_ca.paa";	// Map icon. Delete this entry to use the default icon.
        category = "Nilia_EUFOR";

        function = "Nilia_fnc_Arsenal_Modul";	// Name of function triggered once conditions are met
        ...
        curatorInfoType = "Öffnet ein Menü, indem ausgewählt werden kann, welche Items in ein Limitiertes ACE Arsenal geladen werden sollen."; // Menu displayed when the module is placed or double-clicked on by Zeus
