...
"kka3_ace_extension_Land_BagFence_Long_F","ACE_MapTools","ACE_EntrenchingTool","ACE_Kestrel4500","ItemcTabHCam","ACE_splint","ACE_HuntIR_monitor","NVGogglesB_gry_F","kat_Caffeine",
"ACE_HuntIR_M203","Laserdesignator","ItemMap","ItemcTab","ItemCompass","ItemWatch","Laserbatteries","Rangefinder","ItemAndroid","ACE_adenosine","ACE_SpareBarrel","kat_Pervitin",
