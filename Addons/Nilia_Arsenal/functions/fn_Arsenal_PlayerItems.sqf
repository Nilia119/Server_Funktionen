...
switch (_uid) do {
    ...
    case "76561199107750287": {systemChat "Hey, Benedikt, du hast eigene Items!"; _items = ["CUP_arifle_HK417_12", "rhs_weap_MP44", "hlc_rifle_G36TAC", "rhs_tr8_periscope", "40xtra_nade_throw_stone", "rhsgref_30Rnd_792x33_SmE_StG"];};
    case "76561198242677538": {systemChat "Hey, Pluto, du hast eigene Items!"; _items = ["rhs_weap_m72a7", "itemCompass"];};
    case "76561198246422814": {systemChat "Hey, Sam, du hast eigene Items!"; _items = ["CUP_hgun_TaurusTracker455_gold", "CUP_6Rnd_45ACP_M", "CUP_H_C_MAGA_01"];};
