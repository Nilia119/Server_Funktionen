...
private _none = _NoneKeine + _NoneRadio + _NonecTABs + _NonecTABs1 + _NoneLaser + _NoneRF + _NoneItemsSan + _NoneItemsSanKlasse + _NoneItemsZgFhr + _NoneKompakt1;
// Gefreiter
...
private _Obergefreiter = _ObergefreiterKeine + _ObergefreiterKompakt1 + _Gefreiter;
// Hauptgefreiter
...
private _Hauptgefreiter = _HauptgefreiterKeine + _HauptgefreiterKompakt1 + _Obergefreiter;
// Stabsgefreiter
...
private _Stabsgefreiter = _StabsgefreiterKeine + _StabsgefreiterKompakt1 + _Hauptgefreiter;
// Oberstabsgefreiter
...
private _Oberstabsgefreiter = _OberstabsgefreiterKeine + _OberstabsgefreiterKompakt1 + _Stabsgefreiter;
// Korporal
...
private _Stabskorporal = _StabskorporalKeine + _StabskorporalKompakt1 + _Korporal;
