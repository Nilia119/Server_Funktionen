...
private _none = _NoneKeine + _NoneUAV + _NoneTortilia + _NoneRadio + _NonecTABs + _NonecTABs1 + _NoneLaser + _NoneRF + _NoneStandard;
// Gefreiter
...
private _Obergefreiter = _ObergefreiterKeine + _ObergefreiterStandard + _Gefreiter;
// Hauptgefreiter
...
private _Stabsgefreiter = _StabsgefreiterKeine + _StabsgefreiterStandard + _Hauptgefreiter;
// Oberstabsgefreiter
