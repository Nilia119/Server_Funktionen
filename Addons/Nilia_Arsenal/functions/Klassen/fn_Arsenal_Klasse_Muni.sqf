...
private _NoneAmmo = [] call Nilia_fnc_Klasse_Attire_Ammo;
private _none = _NoneKeine + _NoneStandard + _NoneAmmo;
// Gefreiter
...
private _Korporal = _KorporalKeine + _KorporalStandard + _KorporalTortilia + _Oberstabsgefreiter;
// Stabskorporal
...
private _Stabskorporal = _StabskorporalKeine + _StabskorporalStandard + _StabskorporalUAV + _Korporal;
