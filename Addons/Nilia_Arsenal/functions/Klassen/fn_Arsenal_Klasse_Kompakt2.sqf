...
private _none = _NoneKeine + _NoneKompakt2;
// Gefreiter
...
private _Gefreiter = _GefreiterKeine + _GefreiterKompakt2 + _none;
// Obergefreiter
...
private _Obergefreiter = _ObergefreiterKeine + _ObergefreiterKompakt2 + _Gefreiter;
// Hauptgefreiter
...
private _Hauptgefreiter = _HauptgefreiterKeine + _HauptgefreiterKompakt2 + _Obergefreiter;
// Stabsgefreiter
...
private _Stabsgefreiter = _StabsgefreiterKeine + _StabsgefreiterKompakt2 + _Hauptgefreiter;
// Oberstabsgefreiter
...
private _Oberstabsgefreiter = _OberstabsgefreiterKeine + _OberstabsgefreiterKompakt2 + _Stabsgefreiter;
// Korporal
...
private _Stabskorporal = _StabskorporalKeine + _StabskorporalKompakt2 + _Korporal;
